...
This project explored how technology adoption and district-level educational characteristics may relate to student performance outcomes across public school systems in the United States.

To support this analysis, I developed an end-to-end educational analytics workflow using Python, PostgreSQL, SQL, and Quarto. Multiple public education datasets were extracted, cleaned, transformed, integrated, and analyzed within a dimensional warehouse environment designed specifically for educational outcome and technology participation analysis.

The workflow combined:

- CCD operational education data
- NAEP mathematics performance data
- CRDC district characteristic data
- CRDC distance education participation data

By integrating these datasets into a unified analytics pipeline, the project enabled state-level and district-level evaluation of enrollment trends, post-pandemic educational performance patterns, and technology-enabled learning participation.

Several important findings emerged throughout the analysis:

- Educational performance varied significantly across states and educational systems.
- Post-pandemic mathematics performance declines were visible across many states.
- Larger educational systems did not consistently outperform smaller systems academically.
- Technology-enabled learning participation varied widely across districts and states.
- Higher levels of distance education participation alone did not automatically correspond to stronger academic performance outcomes.
- Educational outcomes appeared influenced by multiple interconnected factors including technology accessibility, implementation quality, instructional effectiveness, enrollment scale, and educational equity.

The analysis suggests that technology adoption plays a meaningful role in modern educational systems, but the effectiveness of technology-enabled learning appears heavily dependent on how technology is implemented, supported, and made accessible to students across different educational environments.

Most importantly, this project demonstrates how modern data engineering and analytics workflows can be used to transform large-scale educational and technology-related datasets into meaningful analytical insights. Throughout the project, I applied practical skills in:

- Data ingestion and integration
- ETL and ELT pipeline development
- PostgreSQL warehouse architecture
...
Overall, this project demonstrates how integrated educational data pipelines, warehouse analytics, and technology participation metrics can be combined to support scalable evaluation of technology adoption and student performance outcomes within modern public education systems.